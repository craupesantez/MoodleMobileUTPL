...
MM.lang = {
    ...
    loadPluginLang: function(component, strings) {
        ...
        if (MM.lang.current != 'es') {
            MM.lang.strings['es'][component] = strings;
        }
    },
    ...
    s: function(id, component) {
        ...
        else if (typeof(MM.lang.strings['es']) != 'undefined'
                && typeof(MM.lang.strings['es'][component]) !== 'undefined'
                && typeof(MM.lang.strings['es'][component][id]) !== 'undefined') {
            translated = MM.lang.strings['es'][component][id];
        }
