...
MM.lang = {
    ...
    determine: function() {
        ...
        console.log("funcion determine: " +MM.config.default_lang);
    ...
    loadPluginLang: function(component, strings) {
        ...
        if (MM.lang.current != 'en') {
         ...
         console.log("funcion loadPluginLang: " );
    },
    ...
    pluginName: function(plugin) {
        ...
        console.log("funcion pluginName: " +plugin);
    ...
    s: function(id, component) {
        ...
        console.log(" funcion s: "+ translated);
        return translated;
    },
