...
var MM = {
    ...
    addSite: function(e) {
        ...
        var siteurl=$.trim(MM.lang.s("siteurl"));

        console.log("valor de siteurl: "+ siteurl);
        //var siteurl=$.trim("http://www.pcingenier.com/moodle/");
        //console.log("valor de siteurl: "+ siteurl);
...
*/
    ...
    saveSite: function(username, password, siteurl) {
        ...
        console.log("servicio web: "+ MM.config.wsservice);
